...
if [ ! -f makefsdata ]; then
    ...
    gcc -o makefsdata -I../pico-sdk/lib/lwip/src/include -I../pico-sdk/lib/lwip/contrib/ports/unix/port/include -I. -DMAKEFS_SUPPORT_DEFLATE=1 -DMAKEFS_SUPPORT_DEFLATE_ZLIB=1 -DHTTPD_ADDITIONAL_CONTENT_TYPES="{\"svg\", HTTP_HDR_SVG }" ../pico-sdk/lib/lwip/src/apps/http/makefsdata/makefsdata.c -lz
fi
